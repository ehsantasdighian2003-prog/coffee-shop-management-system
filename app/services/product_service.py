...
class ProductService:
    ...
    def _validate_category(self, uow, category_id: int):
    ...
    def _calculate_pages(self, total: int, limit: int):
    ...
    def create_product(self, product_data):
        ...
        with UnitOfWork() as uow:
            ...
            self._validate_category(uow, product_data.category_id)
    ...
    def get_products_paginated(
        self, page: int, limit: int, category_id=None, search=None, sort=None
    ):
        ...
        with UnitOfWork() as uow:
            ...
            total = uow.products.count_products(category_id, search)
            ...
            return {
                ...
                "meta": {
                    ...
                    "limit": limit,
                    "total": total,
                    "pages": self._calculate_pages(total, limit),
                },
            }
